...
export const processLotteryResponse = (
  ...
  const {
    priceTicketInTBCC: priceTicketInCakeAsString,
    discountDivisor: discountDivisorAsString,
    amountCollectedInTBCC: amountCollectedInCakeAsString,
  } = lotteryData

  const discountDivisor = new BigNumber(discountDivisorAsString)
  const priceTicketInTBCC = new BigNumber(priceTicketInCakeAsString)
  const amountCollectedInTBCC = new BigNumber(amountCollectedInCakeAsString)
