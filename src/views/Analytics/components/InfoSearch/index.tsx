...
import { CurrencyLogo, DoubleCurrencyLogo } from 'views/Swap/components/CurrencyLogo'
...
import {Text, Input, Flex, Skeleton, SearchIcon, useMatchBreakpoints} from "../../../../uikit";
    ...
    <>
      ...
      <Container>
        <StyledInput
          ...
          placeholder={t('Search pools & tokens')}
          ref={inputRef}
          onFocus={() => {
            setShowMenu(true)
          }}
        />
        <SearchIcon width='25px' height='auto' style={{position: 'absolute', top:'0', left:  isMobile ? '290px' : '202px'}}/>
