      ...
      >
        <defs>
          <linearGradient id="gradient" x1="0" y1="0" x2="0" y2="1">
            <stop offset="5%" stopColor='#4E89E3' stopOpacity={0.5} />
            <stop offset="100%" stopColor='#DB00FF' stopOpacity={0} />
          </linearGradient>
        </defs>
        <XAxis
          dataKey="time"
        ...
        />
        <Area dataKey="value" type="monotone" stroke='#DB00FF' fill="url(#gradient)" strokeWidth={2} />
      </AreaChart>
    </ResponsiveContainer>
  )
}
