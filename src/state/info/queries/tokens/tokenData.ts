...
import { getPercentChange, getChangeForPeriod, getAmountChange } from 'views/Swap/utils/infoDataHelpers'
import { TokenData } from 'state/info/types'
import { useBnbPrices } from 'views/Swap/hooks/useBnbPrices'
    ...
    const fetch = async () => {
      ...
      if (error) {
        ...
        const formatted = tokenAddresses.reduce((accum: { [address: string]: TokenData }, address) => {
          ...
          const txTotalCount = current?.totalTransactions
